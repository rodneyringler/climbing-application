...
import { updateProgram } from '@/app/lib/program/program-actions';
import { Button } from '@/app/ui-components/button';
import { ProgramForm } from '@/app/lib/definitions';
...
export default function EditProgramForm({ 
  ...
  return (
    <form action={updateProgramWithOldName}>
              ...
              exercises.map((exercise) => (
                <div key={exercise.id} className="flex items-start space-x-2 py-2 border-b border-gray-100 last:border-b-0">
                  <input
                    ...
                    type="checkbox"
                    value={exercise.id}
                    defaultChecked={program.exercises.includes(exercise.id)}
