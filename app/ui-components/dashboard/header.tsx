...
export default function DashboardHeader() {
    return (
    <>
        <div className="transition-0.5s ease-in-out fixed left-0 right-0 top-0 md:left-64 z-10">
            ...
            <div className="w-full flex items-center">
                ...
                <h1 className="text-center text-[45px] flex-1 text-2x1 bottom-0 font-bold" >ClimbTrackr</h1> 
            </div>
        </div>
    </>
    );
